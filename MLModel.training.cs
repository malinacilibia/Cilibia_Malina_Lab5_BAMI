...
namespace Cilibia_Malina_Lab5
{
    public partial class MLModel
    {
        public const string RetrainFilePath =  @"C:\Users\Malina\Desktop\facultate\master\an 1 sem 1\big data\laboratoare\laborator 5\RESTAURANTSCORES.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"InspectionType",outputColumnName:@"InspectionType")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LightGbm(new LightGbmMulticlassTrainer.Options(){NumberOfLeaves=4,NumberOfIterations=1270,MinimumExampleCountPerLeaf=20,LearningRate=0.9999997766729865,LabelColumnName=@"RiskCategory",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.861507121221307,FeatureFraction=0.99999999,L1Regularization=3.883913897721699E-10,L2Regularization=0.9999997766729865},MaximumBinCountPerFeature=254}))      
